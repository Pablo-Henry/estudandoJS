...
const mostrarListaPessoas = function (array) {
    console.log(array)
}
...
const filtrarPorCidade = function (array, cidade) {
    const filtraCidade = pessoas.filter(pessoa => {
...
const filtroCidade = filtrarPorCidade(pessoas, 'paratinga');

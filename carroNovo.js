...
//COPIANDO OS DADOS DO OBJ CARRO UITILIZANDO O SPREAD-OPERATOR
const carroNovo = {
    ...carro,
    sinistro: false
}
...
carroNovo.modelo = 'Vectra'

for (let chave in carroNovo) {
    console.log(`Chave: ${chave}   Valor: ${carroNovo[chave]}`)
}
